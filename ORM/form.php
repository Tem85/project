...
<div class="form_wraper_registration">
    ...
    <form action="object/obj-reg.php" method="post">
...
<div class="form__wraper__authorisation">
    ...
    <?php endif;?>
    <h3 class="form__wraper__authorisation__title">Вы не авторизованы</h3>
    <form action="object/obj-auth.php" method="post">
